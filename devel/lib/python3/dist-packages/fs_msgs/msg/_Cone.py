...
class Cone(genpy.Message):
  _md5sum = "ce1c29c0358a1a503b00a09580fddb69"
  _type = "fs_msgs/Cone"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """geometry_msgs/Point location #x,y,z [m] wrt to the car start location (origin)
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3dB().pack(_x.location.x, _x.location.y, _x.location.z, _x.color))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.location.x, _x.location.y, _x.location.z, _x.color,) = _get_struct_3dB().unpack(str[start:end])
      return self
